...
// func possibleWays(patterns []string, word string) int {
// 	var count int
// 	var pq PQ
// 	heap.Init(&pq)
...
func main() {
	...
	patterns := strings.Split(groups[0], ",")
	for i, p := range patterns {
		patterns[i] = strings.TrimSpace(p)
	}
	fmt.Println(len(patterns))

	words := strings.Split(groups[1], "\n")
